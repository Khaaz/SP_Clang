...
void testLib()
{
    ...
    book_t *     book  = createBook(6, "Harry P");
    book_t *     book2 = createBook(12, "H Potter");
    book_t *     book3 = createBook(5, "HP1");
    book_t *     book4 = createBook(10, "Nul C");
 ...
 * `make clean && make`
 * `./build/prog ./data/lib.txt ./data/borrow.txt ./data/add_borrow.txt
 * ./data/remove_borrow.txt`
 *
